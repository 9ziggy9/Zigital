    ...
    <>
      <div className="shadow-grid">
        <div className='about-me-here'>
          ...
          <p>
            Hello! My name is David and I am the author of this application. I am a software engineer with a particular passion for low-level concepts and simulations of any stripe. I am also an open source enthusiast, so please see my github if you would like to see the source code!
          </p>
        </div>
        ...
        <div className="gh">
          <a href="https://github.com/9ziggy9/Zigital">
        ...
        <div className="lki">
          <a href="https://www.linkedin.com/in/david-rogers-b71595227">
